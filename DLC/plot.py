...
# 读取三个数据集
df_tinyllama = pd.read_csv('/mnt/jfs/ci-dingtalk/autotune/cycles_data_tinyllama.csv', parse_dates=['date'])
df_gemma = pd.read_csv('/mnt/jfs/ci-dingtalk/autotune/cycles_data_gemma.csv', parse_dates=['date'])
df_llama = pd.read_csv('/mnt/jfs/ci-dingtalk/autotune/cycles_data_llama.csv', parse_dates=['date'])
