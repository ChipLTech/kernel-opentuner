  ...
  def run_precompiled(self, desired_result, input, limit, compile_result, id):
    ...
    if self.is_executor:
      ...
      run_cmd = "DLC_VISIBLE_DEVICES={0} ACCELERATE_TORCH_DEVICE=dlc python3 sft_trainer.py --device=dlc \
                --model=./tinyllama-15M --max_seq_length=512 --dtype=bfloat16 --dropout=0.05".format(dlc_id)
...
if __name__ == '__main__':
  ...
  with open('/mnt/jfs/ci-dingtalk/autotune/tinyllama/cycles_data_tinyllama.csv', 'a', newline='') as csvfile:
